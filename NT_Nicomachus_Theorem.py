...
class SquareEqualCubes(Scene):
    def construct(self):
        ...
        # test
        # comment_list = ["This is a very very big sentence", 
        # "which needs to be divided into two lines"]

        # comment = VGroup(*[TextMobject(item) for item in comment_list]).arrange(DOWN)
